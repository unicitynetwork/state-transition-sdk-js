...
import { SparseMerkleTreePathStep } from '../../../src/mtree/plain/SparseMerkleTreePathStep.js';
...
describe('SparseMerkleTreePath', () => {
  ...
  it('should verify inclusion path', async () => {
    ...
    expect(await path.verify(0b111n)).toEqual({ isPathIncluded: false, isPathValid: true, isSuccessful: false });
  });
